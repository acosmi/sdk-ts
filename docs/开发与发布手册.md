...
| 当前版本 | **2.17.0**（桌面 loopback OAuth state 全路径闸 + 端口确定性关闭，安全修复，2026-08-15；近期链 2.13.0 窗口重置券 / 2.14.0 inputModalities 开放值域 / 2.15.0 sources 四态 / 2.16.0 chat 超时预算下传 + 流式活性回调，完整明细以 CHANGELOG 为唯一真源） |
