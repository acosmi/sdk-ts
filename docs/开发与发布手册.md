...
└── acosmi-sdk-ts/  (cp -r)      └── github.com/acosmi/acosmi-sdk-ts
...
```
github.com/acosmi/acosmi-sdk-ts (public, MIT)
```
...
git init
git remote add origin https://github.com/acosmi/acosmi-sdk-ts.git
...
- 公开仓：https://github.com/acosmi/acosmi-sdk-ts
